...
void UKF::ProcessMeasurement(MeasurementPackage meas_package) {
  ...
  */
  ...
  double delta_t = (meas_package.timestamp_ - previous_timestamp_) / 1000000.0;	//expressed in seconds
  previous_timestamp_ = meas_package.timestamp_;
...
void UKF::UpdateLidar(MeasurementPackage meas_package) {
  ...
  */
  ...
  //-->>
  // Convert sigma points to the measurement space
  ...
  //-->>
  // Calculate mean and predicted measurement
  ...
  //--> Update state and covariance Matrixes
  // Raw measuremente
  VectorXd z(n_z_lidar);
